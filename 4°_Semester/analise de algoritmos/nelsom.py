...
test_cases = [
    ...
    # Novos casos
    ('Aleatório 5000', generate_random(5000)),
    ('Ordenado 5000', generate_sorted(5000)),
    ('Invertido 5000', generate_reversed(5000)),
    ('Duplicados 5000', generate_duplicates(5000)),
    ('Quase Ordenado 5000', generate_nearly_sorted(5000)),
    
    ('Aleatório 10000', generate_random(10000)),
    ('Ordenado 10000', generate_sorted(10000)),
    ('Invertido 10000', generate_reversed(10000)),
    ('Duplicados 10000', generate_duplicates(10000)),
    ('Quase Ordenado 10000', generate_nearly_sorted(10000)),
]
